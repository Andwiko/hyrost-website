 ...
 * Masks file and directory URLs into stealth tokens (e.g. ?=pv3Ad)
 * =============================================================================
 */
...
(function (global) {
  ...
  function getStealthTokenForPath(path) {
    ...
    return FILE_TO_TOKEN[clean] || null;
  }
  ...
  function applyStealthAddressBar() {
    try {
      ...
      // If already has stealth token in query (e.g. ?=pv3Ad or ?p=pv3Ad or ?pv3Ad)
      if (search.includes('=')) {
